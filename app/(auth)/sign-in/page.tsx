...
const SignInPage = () => {
  ...
  <section className="flex flex-col items-center justify-center min-h-screen bg-background px-4 py-16 md:py-32">
    ...
    <Button variant={'default'} className="max-w-sm mt-5 w-full px-7 py-7 flex flex-row justify-center items-center cursor-pointer" onClick={()=> authClient.signIn.social({
        provider: "github",
        callbackURL: "/"
    })}>
      <Image
